...
void ParamStore::LoadPresets() {
  ...
  raw.MagXOffset = 7.15559368f;
  raw.MagYOffset = -196.75254773f;
  raw.MagZOffset = 282.78573528f;

  raw.MagEllipsoidAInv[0][0] = 7.78583592e-03f;
  raw.MagEllipsoidAInv[0][1] = -3.65206706e-04f;
  raw.MagEllipsoidAInv[0][2] = 5.52328167e-04f;

  raw.MagEllipsoidAInv[1][0] = -3.65206706e-04f;
  raw.MagEllipsoidAInv[1][1] = 7.21988342e-03f;
  raw.MagEllipsoidAInv[1][2] = 3.79955892e-06f;

  raw.MagEllipsoidAInv[2][0] = 5.52328167e-04f;
  raw.MagEllipsoidAInv[2][1] = 3.79955892e-06f;
  raw.MagEllipsoidAInv[2][2] = 7.74409334e-03f;
